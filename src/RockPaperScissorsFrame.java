...
public class RockPaperScissorsFrame extends JFrame {
    ...
    private void createLabelPanel(){
        JLabel titleLbl = new JLabel("Rock, Paper, Scissors Game! - Created by Yishak Teklemariam (Teklemya)");
    ...
    private void createCmdPanel(){
        ...
        ImageIcon rockImg = new ImageIcon(System.getProperty("user.dir") + "/src/stone.png");
        ImageIcon paperImg = new ImageIcon(System.getProperty("user.dir") + "/src/reach.png");
        ImageIcon scissorsImg = new ImageIcon(System.getProperty("user.dir") + "/src/scissors.png");
        ImageIcon quitImg = new ImageIcon(System.getProperty("user.dir") + "/src/shutdown.png");
